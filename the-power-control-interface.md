...
This interface is primarily intended to be used with [Ubuntu Core](glossary.md#the-power-control-interface-heading--ubuntu-core).
...
<h2 id='the-power-control-interface-heading--dev-details'>Developer details </h2>
