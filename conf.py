...
ogp_site_url = "https://dboddie-canonical-work.github.io/disgorged-docs"
ogp_site_name = project
ogp_image = "https://assets.ubuntu.com/v1/253da317-image-document-ubuntudocs.svg"

# Update with the favicon for your product
html_favicon = "_sphinx/_static/favicon.png"
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '_sphinx', '*.md', '*.json']
