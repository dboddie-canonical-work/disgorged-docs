> :information_source: This page documents the format of the **built** snaps. See [The snapcraft format](/t/the-snapcraft-format/8337) for more information about the `snapcraft.yaml` file used to build these snaps.
